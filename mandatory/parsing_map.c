...
/*   Updated: 2024/06/01 23:47:50 by mel-akhd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	put_rows(t_cub3d *cub, t_map_row *map_row, int max_row_size,
		int row_count)
{
	int			row_index;
	t_map_row	*crow;
	...
	while (crow)
	{
		cub->map.addr[row_index] = (char *)malloc(sizeof(char) * (max_row_size
					+ 1));
