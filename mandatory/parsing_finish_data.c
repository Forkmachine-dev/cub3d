...
/*   Updated: 2024/06/01 20:49:57 by mel-akhd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int determin_scale(t_cub3d *cub)
{
    ...
    int width_pixel_count_for_initail_scale;
    int height_pixel_count_for_initail_scale;
    
    initial_mini_map_scale = 1;
    width_pixel_count_for_initail_scale = cub->map.width * TILE_SIZE * initial_mini_map_scale;
    height_pixel_count_for_initail_scale = cub->map.height * TILE_SIZE * initial_mini_map_scale;
